...
public class JdbcTpccService implements TpccService {
    ...
    public NewOrderVO newOrder(NewOrderRequest request) {
        ...
        insertTransactionLog(txId, "new_order", elapsedMs, null);
    ...
    public PaymentVO payment(PaymentRequest request) {
        ...
        long elapsedMs = elapsed(start);
        insertTransactionLog(txId, "payment", elapsedMs, null);
    ...
    private void insertTransactionLog(String txId, String type, long elapsedMs, String errorMessage) {
        ...
        jdbcTemplate.update("""
            ...
            VALUES (?, ?, 'committed', ?, ?, ?)
            """, txId, type, elapsedMs, errorMessage, userId);
    }
