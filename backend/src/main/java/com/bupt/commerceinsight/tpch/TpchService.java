...
public class TpchService {
    ...
    public TpchResultVO<Q1RecordVO> q1(LocalDate shipDate) {
        ...
        List<Q1RecordVO> records = List.of(
            new Q1RecordVO("A", "F", new BigDecimal("37734107.00"), new BigDecimal("56586554400.73"), new BigDecimal("53758257134.87"), new BigDecimal("25.52"), 1478493L),
            new Q1RecordVO("N", "O", new BigDecimal("74476040.00"), new BigDecimal("111701729697.74"), new BigDecimal("106118230307.61"), new BigDecimal("25.50"), 2920374L)
        );
